...
//                 <span
//                   key={skill}
//                   className="inline-flex items-center rounded-md bg-[#F5F5F5] px-3 py-1.5 text-[13px] font-normal text-ijp-near-black leading-tight"
//                 >
//                   {skill}
//                 </span>
//               ))}
...
//                 <h3 className="text-[15px] font-medium text-ijp-near-black mb-3 leading-tight">
//                     Reason for Rejection
//                 </h3>
//                 <p className="text-[13px] text-ijp-near-black leading-relaxed">
