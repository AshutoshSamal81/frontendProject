    ...
    <div className="w-[330px] flex-shrink-0">
      <div className="rounded-lg bg-white px-6 py-5 shadow-sm border border-gray-100">
        ...
        <div className="mb-5 flex items-center justify-between">
          <h2 className="text-[15px] font-medium text-ijp-near-black leading-tight">Filter</h2>
        ...
        <div className="space-y-[18px]">
          {/* Date Picker */}
          <div>
            <label className="mb-[6px] block text-[13px] font-normal text-ijp-near-black leading-tight">
              Date
            </label>
